...
#SBATCH --exclusive
#SBATCH -t 01:00:00
#SBATCH -J te-nvfp4-linear
#SBATCH -o outputs/ltx23-te-nvfp4-linear-select/slurm-%j.out
#SBATCH -e outputs/ltx23-te-nvfp4-linear-select/slurm-%j.err
...
mkdir -p outputs/ltx23-te-nvfp4-linear-select

.conda/ltx23/bin/python scripts/ltx/bench_te_nvfp4_linear_select.py \
  --out outputs/ltx23-te-nvfp4-linear-select/result.json \
  --repeats 5 \
  --warmup 3
