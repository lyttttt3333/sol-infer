...
#SBATCH --mem=0
#SBATCH -t 00:50:00
#SBATCH -J ltx23-efftestw
#SBATCH -o outputs/slurm/ltx23-efftestw-%j.out
#SBATCH -e outputs/slurm/ltx23-efftestw-%j.err
...
ROOT="${ROOT:-outputs/ltx23-efftest-warm}"; export ROOT FORCE=1 WARMUP=true WARMUP_STEPS=15
